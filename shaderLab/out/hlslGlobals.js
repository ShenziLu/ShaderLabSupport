...
exports.keywords = exports.datatypes = exports.semantics = exports.semanticsNum = exports.preprocessors = exports.hlslfunction = exports.cgfunction = exports.shaderConstant = exports.intrinsicfunctions = exports.IEntry = void 0;
class IEntry {
}
...
exports.shaderConstant = {
    ...
    _Time: {
        description: 'float4 t/20, t, t*2, t*3.'
    },
    _SinTime: {
        description: 'float4 t/8, t/4, t/2, t.'
    },
    _CosTime: {
        description: 'float4 t/8, t/4, t/2, t.'
    },
    ...
    unity_LightPosition: {
        description: 'float4[8] direction (-direction,0) spot/point (position,1)'
    },
    unity_LightAtten: {
        description: 'fixed4[8]'
    },
    _LightMatrix0: {
        description: 'float4x4 world to light'
    },
    unity_4LightPosX0: {
        description: 'float4 x position in world'
    },
    unity_4LightPosY0: {
        description: 'float4 y position in world'
    },
    unity_4LightPosZ0: {
        description: 'float4 z position in world'
    },
    unity_WorldToShadow: {
        description: 'float4x4[4] world to shadow'
    },
    unity_AmbientSky: {
        description: 'fixed4 x Gradient Sky Color'
    },
    unity_AmbientEquator: {
        description: 'fixed4 x Gradient Equator Color'
    },
    unity_AmbientGround: {
        description: 'fixed4 x Gradient Ground Color'
    },
    unity_FogColor: {
        description: 'fixed4'
    },
    unity_FogParams: {
        description: 'float4 density/sqrt(ln(2)) density/ln(2) -1/(end-start) end/(end-start)'
    },
    unity_Lightmap: {
        description: 'Texture2D'
    },
    unity_LightmapST: {
        description: 'float4[8]'
    },
    _WorldSpaceCameraPos: {
        description: 'float3'
    },
    _ProjectionParams: {
        description: 'float4 1.0 nearplane farplane 1/farplane'
    },
    _ScreenParams: {
        description: 'float4'
    },
    _ZBufferParams: {
        description: 'float4 1-farplane/nearplane farplane/nearplane x/farplane y/farplane'
    },
    unity_OrthoParams: {
        description: 'float4'
    },
...
exports.cgfunction = {
    UnpackNormal: {
        description: 'fixed3 UnpackNormal(fixed4 normal)'
    },
    Luminance: {
        description: 'half Luminance(half3 rgb)'
    },
    ComputeSrceenPos: {
        description: 'float4 ComputeSrceenPos(float4 pos)'
    },
    ComputeGrabSrceenPos: {
        description: 'float4 ComputeGrabSrceenPos(float4 pos)'
    },
    UnityObjectToWorldNormal: {
        description: 'float3 UnityObjectToWorldNormal(float3 normal)'
    },
    UnityObjectToClipPos: {
        description: 'float4 UnityObjectToClipPos(float3 pos)'
    },
    UnityObjectToViewPos: {
        description: 'float3 UnityObjectToViewPos(float3 pos)'
    },
    UnityWorldToViewPos: {
        description: 'float3 UnityWorldToViewPos(float3 pos)'
    },
    UnityWorldToClipPos: {
        description: 'float4 UnityWorldToClipPos(float3 pos)'
    },
    UnityViewToClipPos: {
        description: 'float4 UnityViewToClipPos(float3 pos)'
    },
    UnityWorldToObjectDir: {
        description: 'float3 UnityWorldToObjectDir(float3 pos)'
    },
    UnityObjectToWorldDir: {
        description: 'float3 UnityObjectToWorldDir(float3 pos)'
    },
    WorldSpaceLightDir: {
        description: 'float3 WorldSpaceLightDir(in float4 localPos)'
    },
    UnityWorldSpaceLightDir: {
        description: 'float3 UnityWorldSpaceLightDir(in float4 worldPos)'
    },
    ObjSpaceLightDir: {
        description: 'float3 ObjSpaceLightDir(in float4 localPos)'
    },
    Shade4PointLights: {
        description: 'float3 Shade4PointLights(...)'
    },
    ObjSpaceViewDir: {
        description: 'float3 ObjSpaceViewDir(float4 localPos)'
    },
    WorldSpaceViewDir: {
        description: 'float3 WorldSpaceViewDir(float4 localPos)'
    },
    UnityWorldSpaceViewDir: {
        description: 'float3 UnityWorldSpaceViewDir(float3 worldPos)'
    },
};
exports.hlslfunction = {
    GetWorldToObjectMatrix: {
        description: 'float4x4 GetWorldToObjectMatrix()'
    },
    GetObjectToWorldMatrix: {
        description: 'float4x4 GetObjectToWorldMatrix()'
    },
    GetWorldToViewMatrix: {
        description: 'float4x4 GetWorldToViewMatrix()'
    },
    GetWorldToHClipMatrix: {
        description: 'float4x4 GetWorldToHClipMatrix()'
    },
    GetViewToHClipMatrix: {
        description: 'float4x4 GetViewToHClipMatrix()'
    },
    TransformObjectToWorld: {
        description: 'float3 TransformObjectToWorld(float3 localPos)'
    },
    TransformWolrdToObject: {
        description: 'float3 TransformWolrdToObject(float3 worldPos)'
    },
    TransformWolrdToView: {
        description: 'float3 TransformWolrdToView(float3 worldPos)'
    },
    TransformWolrdToHClip: {
        description: 'float3 TransformWolrdToHClip(float3 worldPos)'
    },
    TransformObjectToHClip: {
        description: 'float3 TransformObjectToHClip(float3 localPos)'
    },
    TransformWViewToHClip: {
        description: 'float3 TransformWViewToHClip(float3 viewPos)'
    },
    TransformObjectToWorldDir: {
        description: 'float3 TransformObjectToWorld(float3 localPos,bool normalize = true)'
    },
    TransformWolrdToObjectDir: {
        description: 'float3 TransformWolrdToObject(float3 worldPos,bool normalize = true)'
    },
    TransformWolrdToViewDir: {
        description: 'real3 TransformWolrdToView(real3 worldPos,,bool normalize = true)'
    },
    TransformWolrdToHClipDir: {
        description: 'real3 TransformWolrdToHClip(real3 worldPos,bool normalize = true)'
    },
    TransformObjectToWorldNormal: {
        description: 'float3 TransformObjectToWorldNormal(float3 localNormal,bool normalize = true)'
    },
    TransformWolrdToObjectNormal: {
        description: 'float3 TransformWolrdToObjectNormal(float3 worldNormal,bool normalize = true)'
    },
    TransformObjectToTangent: {
        description: 'real3 TransformObjectToTangent(real3 localPos,real3x3 tangentToWorld)'
    },
    TransformWolrdToTangent: {
        description: 'real3 TransformWolrdToTangent(real3 worldPos,real3x3 tangentToWorld)'
    },
    TransformTangentToWorld: {
        description: 'real3 TransformTangentToWorld(real3 tangentPos,real3x3 tangentToWorld)'
    },
    TransformTangentToObject: {
        description: 'real3 TransformTangentToObject(real3 tangentPos,real3x3 tangentToWorld)'
    },
    GetCameraPositionWS: {
        description: 'float3 GetCameraPositionWS()'
    },
    TRANSFORM_TEX: {
